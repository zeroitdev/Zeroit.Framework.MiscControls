...
// ***********************************************************************
// <copyright file="SevenSegmentCell.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.MiscControls.Digitals.Cells
{
    ...
    public partial class ZeroitSevenCell : ZeroitDigitalCell
    {
        /// <summary>
        /// The padding ratio x
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ZeroitSevenCell"/> class.
        /// </summary>
        public ZeroitSevenCell()
        {
            Value = '0';
