...
// ***********************************************************************
// <copyright file="TabStyleDefaultProvider.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.MiscControls.Tabs
{
	...
	public class TabStyleDefaultProvider : TabStyleProvider
	{
        ...
        public TabStyleDefaultProvider(ZeroitDuredoTab tabControl) : base(tabControl){
