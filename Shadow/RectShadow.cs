...
// ***********************************************************************
// <copyright file="RectShadow.cs" company="Zeroit Dev Technologies">
...
{
    #region ZeroitRectShadow

    #region Control

    /// <summary>
    /// A class collection for rendering a rectangular shadow.
    /// </summary>
    /// <seealso cref="System.Windows.Forms.Button" />
    [Designer(typeof(ZeroitRectShadowDesigner))]
    public class ZeroitRectShadow : Button
    {
        ...
        /// <summary>
        /// Gets or sets the text start point. Point where your text would start getting drawn.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the color gradient. Indicates how sharp a color transition you want.
        /// </summary>
        ...
        #region Constructor        
        /// <summary>
        /// Initializes a new instance of the <see cref="ZeroitRectShadow" /> class.
        /// </summary>
        public ZeroitRectShadow()
        {
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            g.DrawRectangle(new Pen(Color.FromArgb(borderTransparency, borderColor)), 0, 0, ClientSize.Width - space, ClientSize.Height - space);
        ...
        void ColorButton1(Graphics g)
        {
            ...
            g.DrawRectangle(_pen, 0, 0, ClientSize.Width, ClientSize.Height);
            g.FillRectangle(_brushInside, 0, 0, ClientSize.Width, ClientSize.Height);
        }
        ...
        void ColorButton2(Graphics g)
        {
            ...
            {
                g.DrawRectangle(_pen, x, y, ClientSize.Width, ClientSize.Height);
                g.FillRectangle(_brushInside, x, y, ClientSize.Width, ClientSize.Height);
        ...
        void ColorButton3(Graphics g)
        {
            ...
            for (; x <= width / 2 && y <= height / 2; x += _colorStepGradient, y += _colorStepGradient, width -= 2 * _colorStepGradient, height -= 2 * _colorStepGradient)
            {
                ...
                g.FillRectangle(_brushInside, x, y, width, height);
        ...
        void ColorButton5(Graphics g, Pen pen, SolidBrush brush)
        {
            ...
            for (; x <= width / 2 && y <= height / 2; x += _colorStepGradient, y += _colorStepGradient, width -= 2 * _colorStepGradient, height -= 2 * _colorStepGradient)
            {
                ...
                if (_bDrawOutline && (x == 0))
                {
                    ...
                    g.DrawRectangle(_blackPen, x, y, width, height);
                ...
                if (_bDrawOutline && (x == 6))
                {
                    ...
                    g.DrawRectangle(_dashedPen, x, y, width, height);
    ...
    /// <summary>
    /// Class ZeroitRectShadowDesigner.
    /// </summary>
    /// <seealso cref="System.Windows.Forms.Design.ControlDesigner" />
    [System.Security.Permissions.PermissionSet(System.Security.Permissions.SecurityAction.Demand, Name = "FullTrust")]
    public class ZeroitRectShadowDesigner : System.Windows.Forms.Design.ControlDesigner
    {
        /// <summary>
        /// The action lists
        /// </summary>
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                if (null == actionLists)
                {
                    ...
                    actionLists.Add(new ZeroitRectShadowSmartTagActionList(this.Component));
                }
                return actionLists;
            }
        }
    ...
    /// <summary>
    /// Class ZeroitRectShadowSmartTagActionList.
    /// </summary>
    /// <seealso cref="System.ComponentModel.Design.DesignerActionList" />
    public class ZeroitRectShadowSmartTagActionList : System.ComponentModel.Design.DesignerActionList
    {
        //Replace SmartTag with the Component Class Name. In this case the component class name is SmartTag
        /// <summary>
        /// The col user control
        /// </summary>
        private ZeroitRectShadow colUserControl;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ZeroitRectShadowSmartTagActionList"/> class.
        /// </summary>
        /// <param name="component">A component related to the <see cref="T:System.ComponentModel.Design.DesignerActionList" />.</param>
        public ZeroitRectShadowSmartTagActionList(IComponent component) : base(component)
        {
            this.colUserControl = component as ZeroitRectShadow;
