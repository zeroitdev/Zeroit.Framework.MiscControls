...
// ***********************************************************************
// <copyright file="BaseRenderer.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.MiscControls
{
    ...
    public class BseRenderer : ToolStripProfessionalRenderer
    {
        ...
        /// <summary>
        /// Initializes static members of the <see cref="BseRenderer"/> class.
        /// </summary>
        static BseRenderer()
        {
            MarginInset = 2;
        ...
        /// </summary>
        /// <param name="graphics">The graphics.</param>
        /// <param name="menuBounds">The menu bounds.</param>
        /// <param name="gradientColor">Color of the gradient.</param>
