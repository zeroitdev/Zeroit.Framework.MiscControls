...
// ***********************************************************************
// <copyright file="Slider.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.MiscControls
{
	...
	public class ZeroitAnidasoSlider : UserControl
	{
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ZeroitAnidasoSlider" /> class.
        /// </summary>
        public ZeroitAnidasoSlider()
		{
        ...
        /// <summary>
        /// Handles the Load event of the ZeroitAnidasoSlider control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
        private void ZeroitAnidasoSlider_Load(object sender, EventArgs e)
		{
			int num = 0;
			int num1 = 0;
			int num2;
        ...
        /// <summary>
        /// Handles the Resize event of the ZeroitAnidasoSlider control.
        /// </summary>
        /// <param name="sender">The source of the event.</param>
        /// <param name="e">The <see cref="EventArgs"/> instance containing the event data.</param>
        private void ZeroitAnidasoSlider_Resize(object sender, EventArgs e)
		{
        ...
        private void InitializeComponent()
		{
			...
			base.Name = "ZeroitAnidasoSlider";
			base.Size = new System.Drawing.Size(415, 28);
			base.Load += new EventHandler(this.ZeroitAnidasoSlider_Load);
			base.Resize += new EventHandler(this.ZeroitAnidasoSlider_Resize);
