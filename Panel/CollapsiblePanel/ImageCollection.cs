...
// ***********************************************************************
// <copyright file="ImageCollection.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.MiscControls
{
    ...
    /// <remarks>The canonical <see cref="System.Drawing.Size" /> is defined via the <see cref="Size" />
    ...
    /// images are resized.
    /// <para><c>ImageCollection</c> supports the <see cref="TransparentColor" /> property to
    ...
    /// property to <see cref="Color.Empty" /></para><para>
    /// For this version of <c>ImageCollection</c> the pixel format is fixed
    /// at <see cref="PixelFormat.Format32bppArgb" /></para></remarks>
#if DEBUG
    ...
    public class ImageCollection : ICollection, IList
    {
        ...
        /// <returns>An <see cref="System.Windows.Forms.ImageList" /> representation of the
        /// <c>ImageCollection</c></returns>
        ...
        /// ImageCollection(Bitmap,int): Image count must be 0 when bitmap is null
        /// or
        /// ImageCollection(Bitmap,int): Bitmap width is not even multiple of imageCount
        /// </exception>
        /// <remarks>The width of the image strip must be an integral size of <c>imageCount</c>
        /// (i.e., <c>images.Width % imageCount == 0</c>)</remarks>
        ...
        /// <remarks>The images are provided as a <see cref="Bitmap" /> using a single row of <see cref="Count" /> images</remarks>
        [Browsable(false)]
        public Image Images
        {
            get
        ...
        /// <remarks>If required, each image in the collection is re-drawn at the new size</remarks>
        public Size Size
        {
            get
            {
        ...
        /// <remarks>If necessary, the transparency mask value for each <see cref="Image" /> is
        /// set to the new value</remarks>
        ...
        /// <returns>An <see cref="Image" /> that conforms to the canonical size and
        /// transparent color mask for the <c>ImageCollection</c></returns>
        ...
        /// <returns>Image.</returns>
        /// <exception cref="System.ArgumentNullException">Expecting non-null Image/Icon value</exception>
        /// <exception cref="System.ArgumentException">Image type expected. Got " + value.GetType()</exception>
        ...
        /// <returns>The index where the <see cref="Image" /> was added to the
        /// <c>ImageCollection</c></returns>
        ...
        /// <returns>The index where the <see cref="Icon" /> was added to the
        /// <c>ImageCollection</c></returns>
        /// <remarks>The <see cref="Icon" /> must be converted to a <see cref="Bitmap" />
        /// prior to being inserted. The <see cref="Icon" /> defines its own
        /// transparency mask so our transparency color mask is irrelavent</remarks>
        ...
        /// <remarks>See <see cref="ICollection.IsSynchronized" /></remarks>
        [Browsable(false)]
        ...
        /// <remarks>See <see cref="ICollection.Count" /></remarks>
        [ReadOnly(true)]
        public int Count
        {
            get
        ...
        /// <remarks>See <see cref="ICollection.CopyTo(Array,int)" /></remarks>
        ...
        /// <remarks>See <see cref="ICollection.SyncRoot" /></remarks>
        [Browsable(false)]
        ...
        /// <remarks>See <see cref="IEnumerable.GetEnumerator()" /></remarks>
        ...
        /// <remarks>Called by any code that casts the <c>ImageCollection</c> to
        ...
        /// <remarks><see cref="IList.RemoveAt(int)" /></remarks>
        ...
        /// <remarks><see cref="IList.Insert(int,object)" /></remarks>
        ...
        /// <remarks><see cref="IList.Remove(object)" /></remarks>
        ...
        /// <returns><see langword="true" /> if the <c>ImageCollection</c> contains
        /// the specified value, <see langword="false" /> otherwise</returns>
        /// <remarks><see cref="IList.Contains(object)" /></remarks>
        ...
        /// </summary>
        /// <remarks><see cref="IList.Clear()" /></remarks>
        public void Clear()
        {
        ...
        /// </summary>
        /// <param name="value">A value to search for</param>
        /// <returns>The index of the value, or -1 if the value is not
        /// a membe of the <c>ImageCollection</c></returns>
        /// <remarks><see cref="IList.IndexOf(object)" /></remarks>
        ...
        /// <remarks><see cref="IList.IsFixedSize" /></remarks>
        [Browsable(false)]
