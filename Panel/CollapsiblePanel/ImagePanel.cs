...
// ***********************************************************************
// <copyright file="ImagePanel.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.MiscControls
{
    ...
    /// <remarks>The <c>ImagePanel</c> can be run in two different modes:
    /// <list type="bullet"><item>Static Control</item><item>Popup (like a context menu)</item></list><para>
    /// Overall functionality is the same but when in popup mode, various actions/events
    /// cause the <c>ImagePanel</c> to be hidden
    /// </para><para><c>ImagePanel</c> has the following primary properties:
    /// <list type="table"><listheader><term>Property</term><description>Purpose</description></listheader><item><term><see cref="Dimensions" /></term><description>Determines the row/column arrangement for the image grid</description></item><item><term><see cref="HighlightColor" /></term><description></description></item><item><term><see cref="SelectedColor" /></term><description></description></item><item><term><see cref="GridColor" /></term><description></description></item><item><term><see cref="PanelGridSize" /></term><description></description></item><item><term><see cref="AutoSelect" /></term><description></description></item><item><term><see cref="Images" /></term><description></description></item></list></para><para><c>ImagePanel</c> has the following primary events:
    /// <list type="table"><listheader><term>Event</term><description>Purpose</description></listheader><item><term><see cref="PropertyChange" /></term><description></description></item><item><term><see cref="ImageSelected" /></term><description></description></item></list></para><para><c>ImagePanel</c> has the following primary methods:
    /// <list type="table"><listheader><term>Method</term><description>Purpose</description></listheader><item><term><see cref="SetImages(Bitmap,int)" /></term><description></description></item><item><term><see cref="Popup(int,int,Control)" /></term><description></description></item></list></para></remarks>
    [ToolboxItem(false)]
    public class ImagePanel : ScrollableControl
    {
        ...
        /// <returns>Various values. Primarily the wait handle that signaled, but could
        ...
        #region Constants
        /// <summary>
        /// The default selected colors
        /// </summary>
        private static readonly XPanelColorPair DefaultSelectedColors = new XPanelColorPair(Color.White, Color.DodgerBlue);
        #endregion Constants
        ...
        /// </summary>
        private XPanelColorPair selectedColors = DefaultSelectedColors;
        ...
        /// <exception cref="System.ArgumentNullException">imageSet</exception>
        /// <remarks>The best dimensions (rows/cols) are calculated using <see cref="PanelSizeHints.MinimizeBoth" />
        /// which produces the best square. The client rectangle for the <c>ImagePanel</c> is calculated based
        /// upon the dimensions</remarks>
        ...
        #region Properties
        /// <summary>
        /// Get/Set the <see cref="XPanelColorPair" /> which describes the Frame and
        /// Background <see cref="XPanelColorPair" /> values for selected images
        /// </summary>
        /// <value>The selected colors.</value>
        public XPanelColorPair SelectedColors
        {
            get
            {
        ...
        /// <remarks>The <c>HighightColor</c> is used for both the frame of the image as
        ...
        /// <see cref="ImagePanelProperties.SelectedColorsProperty" /></para><para><seealso cref="SelectedColor" /></para></remarks>
        ...
        public Color HighlightColor
        {
            ...
            set
            {
                ...
                {
                    selectedColors = new XPanelColorPair(value, SelectedColor);
                }
            }
        }
        ...
        /// <remarks>The <c>SelectedColor</c> is used for both the frame of the image as
        /// well as the background color. The background color is only visible
        /// when if the image has transparency and the background color of
        /// the image panel is not equivalent. The background/frame color
        ...
        /// <para>
        /// This property (indirectly) sends a <see cref="PropertyChange" /> event with
        /// <see cref="ImagePanelProperties.SelectedColorsProperty" /></para><para><seealso cref="HighlightColor" /></para></remarks>
        ...
        public Color SelectedColor
        {
            ...
            set
            {
                ...
                {
                    selectedColors = new XPanelColorPair(HighlightColor, value);
                }
            }
        }
        ...
        /// <see cref="ImagePanelProperties.GridColorProperty" /></para>
        ...
        /// </summary>
        /// <value>The size of the panel grid.</value>
        /// <remarks>This method fires a <see cref="PropertyChange" /> event with the
        /// <see cref="ImagePanelProperties.PanelGridSizeProperty" /></remarks>
        ...
        /// code generation
        /// </summary>
        /// <returns><see langword="true" /> if the property does not equal its default value</returns>
        ...
        /// Rows must be >= 1
        /// </exception>
        /// <remarks>The ImagePanel grid is define in terms of rows/columns where
        ...
        /// <see cref="ImagePanelProperties.DimensionsProperty" /></para></remarks>
        ...
        /// </summary>
        /// <value><c>true</c> if [automatic select]; otherwise, <c>false</c>.</value>
        /// <remarks>This method fires a <see cref="PropertyChange" /> event with the
        /// <see cref="ImagePanelProperties.AutoSelectProperty" /></remarks>
        ...
        /// <remarks>This method fires a <see cref="PropertyChange" /> event with the
        /// <see cref="ImagePanelProperties.DefaultImageProperty" /></remarks>
        ...
        /// </summary>
        /// <value>The bounce factor.</value>
        /// <exception cref="System.ArgumentException">BounceFactor must be between 0.0 and 1.0 (inclusive)</exception>
        /// <remarks><c>BounceFactor</c> must be between 0.0 and 1.0 inclusive</remarks>
        ...
        /// </summary>
        /// <value>The maximum bounce ratio.</value>
        /// <exception cref="System.ArgumentException">MaxBounceRatio must be >= 1.0</exception>
        /// <remarks><c>MaxBounceRatio</c> must be &gt;= 1.0</remarks>
        ...
        /// </summary>
        /// <value>The minimum bounce ratio.</value>
        /// <exception cref="System.ArgumentException">MinBounceRatio must be <= 1.0</exception>
        /// <remarks><c>MinBounceRatio</c> must be &lt;= 1.0</remarks>
        ...
        /// <exception cref="System.ArgumentException">imageCount must be > 0</exception>
        /// <remarks>This method fires a <see cref="PropertyChange" /> event with the
        /// <see cref="ImagePanelProperties.ImagesProperty" /></remarks>
        ...
        /// <remarks>This method (indirectly) fires a <see cref="PropertyChange" /> event with the
        /// <see cref="ImagePanelProperties.ImagesProperty" /></remarks>
        ...
        /// <returns>The image index selected, or -1 if canceled</returns>
        ...
        /// popup is complete (or <see langword="null" />)</param>
        /// <returns>The image index selected, or -1 if canceled</returns>
        /// <remarks>X/Y coordinates are <see cref="ImagePanelPlacement.TopLeft" /></remarks>
        ...
        /// <returns>The suggested Width (cols) and Height (rows) of the panel as type
        /// <see cref="System.Drawing.Size" /></returns>
        ...
        /// </summary>
        /// <returns>A suggested client rectangle</returns>
        ...
        /// <param name="row">The row</param>
        /// <param name="column">The column</param>
        /// <returns>The rectangle for a given row/column (does not include frame of image)</returns>
        ...
        /// <param name="row">The row</param>
        /// <param name="column">The column</param>
        /// <returns>The rectangle for a given row/column including the frame</returns>
        ...
        /// <param name="row">The row</param>
        /// <param name="column">The column</param>
        /// <returns>The rectangle for the image that corresponds to the row/column</returns>
        ...
        /// <param name="row">The row</param>
        /// <param name="column">The column</param>
        /// <returns>The image index for the specified row/column or -1 if
        /// the coordinates do specify valid coordinates</returns>
        ...
        /// <param name="row">The row</param>
        /// <param name="column">The column</param>
        /// <returns><see langword="true" /> if the coordinates contain an image</returns>
        ...
        /// <returns>The <see cref="Bitmap" /> representation of the <c>ImagePanel</c></returns>
        ...
        /// </summary>
        /// <remarks><seealso cref="DoPopup" /></remarks>
        ...
        /// <returns>The index of the image selected, or -1 if canceled</returns>
        ...
        /// <remarks>We always want this value to be <see langword="true" /></remarks>
        [Browsable(false)]
        ...
        /// <returns><see langword="true" /> if the message was processed, <see langword="false" /> otherwise</returns>
        ...
        /// </summary>
        /// <param name="e"><see cref="MouseEventArgs" /></param>
        /// <remarks>MouseUp triggers <see cref="ImageSelected" /> event if the
        /// mouse down was on a valid image</remarks>
        ...
        /// </summary>
        /// <param name="e">An <see cref="T:System.EventArgs" /> that contains the event data.</param>
        /// <remarks>Note that we don't hide if in popup mode when the mouse leaves</remarks>
        ...
        #region Animation
        /// <summary>
        /// Animates the specified f animation hint.
        /// </summary>
        /// <param name="fAnimationHint">if set to <c>true</c> [f animation hint].</param>
        ...
        /// <summary>
        /// Handles the Tick event of the bounceTimer control.
        /// </summary>
