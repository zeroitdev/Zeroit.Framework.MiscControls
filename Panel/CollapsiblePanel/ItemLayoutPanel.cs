...
// ***********************************************************************
// <copyright file="ItemLayoutPanel.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.MiscControls
{
    ...
    public class ItemLayoutPanel : Panel, ISupportInitialize
    {
        ...
        public interface IItemLayout
        {
            ...
            /// <returns>The "best height" for <c>Parent</c></returns>
            /// <remarks>This method should be implemented as:
            /// <code>
            ...
            /// <returns>The "best height" for <c>Parent</c></returns>
            /// <remarks>This method provides an oppurtunity for selective layout, or to specify a
            /// different control order than the default</remarks>
        ...
        /// </summary>
        /// <seealso cref="Zeroit.Framework.MiscControls.ItemLayoutPanel.IItemLayout" />
        /// <remarks>This is a simple algorithm for (left) aligning and spacing items within an <see cref="ItemLayoutPanel" /><seealso cref="ItemLayoutPanel.ItemLayout" /></remarks>
        class DefaultItemLayout : IItemLayout
        {
            ...
            /// <returns>The offset of the bottom of the last placed control + the
            /// <see cref="UIComponents.ItemLayoutPanel.BorderMargin" /></returns>
            /// <remarks>This method provides an oppurtunity for selective layout, or to specify a
            /// different control order than the default</remarks>
        ...
        /// </summary>
        /// <param name="itemLayoutPanel">The item layout panel.</param>
        /// <param name="e">The <see cref="PropertyChangeEventArgs"/> instance containing the event data.</param>
        ...
        public class PropertyChangeEventArgs : System.EventArgs
        {
            ...
            public ItemLayoutPanelProperty ZeroitPandaPanelProperty
            {
                get
                {
                    return property;
        ...
        /// <summary>
        /// Controls the Y spacing between <see cref="XPanelTextElement" /> items in the <c>ItemLayoutPanel</c>
        /// </summary>
        ...
        /// </summary>
        /// <remarks>The <see cref="Control.BackColor" /> property is set to <see cref="Color.Transparent" />, and
        /// the <see cref="ScrollableControl.AutoScroll" /> property is set to <see langword="true" /></remarks>
        ...
        /// <remarks><see cref="BackgroundStyle" /> for more information.
        /// Note: This is probably NOT one of my better ideas...</remarks>
        ...
        /// <remarks>Fires a PropertyChange event w/ <see cref="ItemLayoutPanelProperty.PanelGradientProperty" /> argument</remarks>
        [Category("Appearance"),
        ...
        /// <remarks>Fires a PropertyChange event w/ <see cref="ItemLayoutPanelProperty.BorderMarginProperty" /> argument</remarks>
        [Category("Layout"),
        ...
        /// <remarks>Default value for this property is <see cref="DefaultSpacing" /><para>Fires a PropertyChange event w/ <see cref="ItemLayoutPanelProperty.ItemSpacingProperty" /> argument</para></remarks>
        [Category("Layout"),
        ...
        /// <see cref="ZeroitPandaPanel" /> based on its size
        /// </summary>
        ...
        /// <exception cref="System.ArgumentException">ItemLayoutPanel.MoveItem: Invalid item indices</exception>
        ...
        /// ItemLayoutPanel.MoveItem: Invalid item index
        /// or
        /// ItemLayoutPanel.MoveItem: Unknown control
        /// </exception>
        ...
        /// </summary>
        /// <param name="showItems">if set to <c>true</c> [show items].</param>
