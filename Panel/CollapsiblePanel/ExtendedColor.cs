...
// ***********************************************************************
// <copyright file="ExtendedColor.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.MiscControls
{
    ...
    /// <remarks>The .NET Framework exposes HSL components of <see cref="Color" /> values in
    ...
    public class ExtendedColor : ICloneable
    {
        ...
        /// <returns>The <see cref="Color" /> value for the <c>ExtendedColor</c></returns>
        ...
        /// <returns>The equivalent <see cref="Color" /> value for the specified HSL definition</returns>
        ...
        /// </summary>
        /// <returns>A clone of this <c>ExtendedColor</c></returns>
        ...
        /// </summary>
        /// <param name="hue">The normalized hue value</param>
        /// <returns>The equivalent hue value in degrees</returns>
        ...
        /// </summary>
        /// <value>The hue.</value>
        /// <remarks>This value is always specified using the normalized form (0.0 -&gt; 1.0)</remarks>
        public double Hue
        {
            get
            {
        ...
        /// non-normalized form
        /// </summary>
        /// <value>The hue non normalized.</value>
        ...
        /// <remarks>Internally the .NET Framework refers to this value as Brightness
        /// (<see cref="System.Drawing.Color.GetBrightness()" />)</remarks>
