...
// ***********************************************************************
// <copyright file="BaseColorCollection.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.MiscControls
{
    ...
    /// such because it causes issues with the IDE designer</para></remarks>
	[Serializable]
    public class BaseColorCollection : ICloneable /*: ICollection*/
    {
        ...
        /// <exception cref="System.ArgumentException">The number of colors in the collection must be > 0</exception>
        ...
        /// </summary>
        /// <returns>A clone of this <c>BaseColorCollection</c></returns>
        ...
        /// Color index (" + index + ") out-of-range
        /// or
        /// Color index (" + index + ") out-of-range
        /// </exception>
        ...
        /// </summary>
        /// <returns>The hashcode for the <c>BaseColorCollection</c></returns>
        ...
        /// <returns>String representation of the <see cref="Color" /> value.</returns>
        /// <remarks><seealso cref="Color.ToString()" /></remarks>
        ...
        /// </summary>
        /// <returns>An <see cref="IEnumerator" /> for the <c>colors</c> array</returns>
