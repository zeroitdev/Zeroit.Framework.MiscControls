...
namespace Zeroit.Framework.MiscControls
{
    ...
    #region UniqueButtonExitMaximize    
    /// <summary>
    /// A class collection for rendering button.
    /// </summary>
    /// <seealso cref="System.Windows.Forms.Control" />
    [Designer(typeof(ZeroitControlBoxUniqueMaximizeDesigner))]
    public class ZeroitControlBoxUniqueMaximize : Control
    {
        ...
        /// <summary>
        /// Gets or sets the background color pressed.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the background border color when pressed.
        /// </summary>
        ...
        #region Constructor        
        /// <summary>
        /// Initializes a new instance of the <see cref="ZeroitControlBoxUniqueMaximize"/> class.
        /// </summary>
        public ZeroitControlBoxUniqueMaximize()
        {
    ...
    public class ZeroitControlBoxUniqueMaximizeDesigner : System.Windows.Forms.Design.ControlDesigner
    {
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                if (null == actionLists)
                {
                    ...
                    actionLists.Add(new ZeroitControlBoxUniqueMaximizeSmartTagActionList(this.Component));
                }
                return actionLists;
            }
        }
    ...
    public class ZeroitControlBoxUniqueMaximizeSmartTagActionList : System.ComponentModel.Design.DesignerActionList
    {
        //Replace SmartTag with the Component Class Name. In this case the component class name is SmartTag
        private ZeroitControlBoxUniqueMaximize colUserControl;


        private DesignerActionUIService designerActionUISvc = null;


        public ZeroitControlBoxUniqueMaximizeSmartTagActionList(IComponent component) : base(component)
        {
            this.colUserControl = component as ZeroitControlBoxUniqueMaximize;
