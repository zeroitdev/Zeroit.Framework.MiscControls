...
namespace Zeroit.Framework.MiscControls
{
    ...
    #region UniqueButtonExitMinimize    
    /// <summary>
    /// A class collection for rendering a button.
    /// </summary>
    /// <seealso cref="System.Windows.Forms.Control" />
    [Designer(typeof(ZeroitControlBoxUniqueMinimizeDesigner))]
    public class ZeroitControlBoxUniqueMinimize : Control
    {
        ...
        /// <summary>
        /// Gets or sets the background color whend the control is pressed.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the background color border color when the control is pressed.
        /// </summary>
        ...
        public ZeroitControlBoxUniqueMinimize()
        {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            #region Remove this code in case of any errors caused
            if (Width > 0 && Height > 0)
            {
                Shape = new GraphicsPath();
                R1 = new Rectangle(0, 0, Width, Height);
    ...
    public class ZeroitControlBoxUniqueMinimizeDesigner : System.Windows.Forms.Design.ControlDesigner
    {
        ...
        public override DesignerActionListCollection ActionLists
        {
            get
            {
                if (null == actionLists)
                {
                    ...
                    actionLists.Add(new ZeroitControlBoxUniqueMinimizeSmartTagActionList(this.Component));
                }
                return actionLists;
            }
        }
    ...
    public class ZeroitControlBoxUniqueMinimizeSmartTagActionList : System.ComponentModel.Design.DesignerActionList
    {
        //Replace SmartTag with the Component Class Name. In this case the component class name is SmartTag
        private ZeroitControlBoxUniqueMinimize colUserControl;


        private DesignerActionUIService designerActionUISvc = null;


        public ZeroitControlBoxUniqueMinimizeSmartTagActionList(IComponent component) : base(component)
        {
            this.colUserControl = component as ZeroitControlBoxUniqueMinimize;
