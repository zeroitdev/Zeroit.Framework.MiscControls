...
// ***********************************************************************
// <copyright file="ExpandCollapseButton.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.MiscControls
{
    ...
    public partial class ZeroitPiperExCollapseButton : UserControl
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ZeroitPiperExCollapseButton"/> class.
        /// </summary>
        public ZeroitPiperExCollapseButton()
        {
            InitializeComponent();
        ...
        /// <exception cref="ArgumentOutOfRangeException">style</exception>
        ...
        protected virtual void OnExpandCollapse()
        {
            ...
            if (handler != null)
                handler(this, new PiperExpandCollapseEventArgs(_isExpanded));
        }
