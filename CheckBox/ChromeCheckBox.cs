...
// ***********************************************************************
// <copyright file="ChromeCheckBox.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.MiscControls
{
    ...
    #region ZeroitCheckBoxChrome    
    /// <summary>
    /// A class collection for rendering a checkbox.
    /// </summary>
    /// <seealso cref="Zeroit.Framework.MiscControls.ThemeControl154" />
    [DefaultEventAttribute("CheckedChanged")]
    public class ZeroitCheckBoxChrome : ThemeControl154
    {

        #region Constructor

        /// <summary>
        /// Initializes a new instance of the <see cref="ZeroitCheckBoxChrome" /> class.
        /// </summary>
        public ZeroitCheckBoxChrome()
        {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="ZeroitCheckBoxChrome" /> is checked.
        /// </summary>
        ...
        protected override void PaintHook()
        {
            ...
            LGB = new LinearGradientBrush(new Rectangle(0, 0, 14, 5), Color.Transparent, Color.Transparent, 90f);
