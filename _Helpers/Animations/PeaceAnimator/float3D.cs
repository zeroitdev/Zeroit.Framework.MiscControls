...
// ***********************************************************************
// <copyright file="float3D.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.MiscControls.HelperControls.AnimationHelpers.WinFormAnimation
{
    ...
    /// <seealso cref="System.IEquatable{Zeroit.Framework.MiscControls.HelperControls.AnimationHelpers.WinFormAnimation.Float3D}" />
    /// <seealso cref="System.IEquatable{System.Drawing.Color}" />
    public class Float3D : IConvertible, IEquatable<Float3D>, IEquatable<Color>
    {
        ...
        /// <param name="z">The depth value</param>
        ...
        /// </summary>
        /// <returns>A hash code for the current <see cref="Float3D" />.</returns>
        ...
        /// </summary>
        /// <param name="float3D">The <see cref="Float3D" /> class to convert</param>
        /// <returns>A new instance of the <see cref="Color" /> class representing the values in the <see cref="Float3D" /> instance</returns>
        ...
        /// </summary>
        /// <returns>A string that represents the current <see cref="Float3D" />.</returns>
