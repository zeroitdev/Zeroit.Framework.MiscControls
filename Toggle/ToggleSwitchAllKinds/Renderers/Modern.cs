...
{
    #region Modern Renderer
    /// <summary>
    /// Class ToggleSwitchModernRenderer.
    /// </summary>
    ...
    public class ToggleSwitchModernRenderer : ToggleSwitchRendererBase, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ToggleSwitchModernRenderer"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the color of the arrow normal.
        /// </summary>
